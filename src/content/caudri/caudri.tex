...
\input{content/caudri/einfuehrung}
\input{content/caudri/disziplinen}
\input{content/caudri/obstacle}
\input{content/caudri/reize}
\input{content/caudri/zukunft}
\input{content/caudri/geschichte}
\input{content/caudri/schluss}
